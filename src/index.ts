...
import { Hunter1 } from "enemy.types"
...
Enemy.add(new Hunter1(256, 256, "n"));

Enemy.add(new Hunter1(512, 512, "n"));

Enemy.add(new Hunter1(768, 768, "d"));

Enemy.add(new Hunter1(1024, 1024, "v"));
